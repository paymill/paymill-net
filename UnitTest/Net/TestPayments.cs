...
namespace UnitTest.Net
{
    ...
    public class TestPayments
    {
        ...
        {
            IReadOnlyCollection<Payment> lstPayments = _paymill.PaymentService.GetPayments();
            Assert.IsFalse(lstPayments.Count == 0, "GetPayments Fail");
         }
        [TestMethod]
        public void CreatePayment()
        {
            Payment payment = _paymill.PaymentService.Create("098f6bcd4621d373cade4e832627b4f6");
        ...
        public void CreatePaymentWithclient()
        {
            ...
            Payment payment = _paymill.PaymentService.Create("098f6bcd4621d373cade4e832627b4f6", client.Id);
        ...
        {
            Payment payment = _paymill.PaymentService.Create("098f6bcd4621d373cade4e832627b4f6");
            bool reply = _paymill.PaymentService.Remove(payment.Id);
        ...
        {
            bool reply = _paymill.PaymentService.Remove("pay_3af44644dd6d25c8hhhhh");
            Assert.IsTrue(reply, "RemovePayment Fail");
        }
    }
}
